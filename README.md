...
- **Variable Delta-Sync:** 1MB/256KB fragment streaming ensures zero OOM crashes even for multi-gigabyte saves.
- **SAF & Shizuku Bridge:** High-speed access to restricted `Android/data` folders via Storage Access Framework or Shizuku.

## Features
- **Cloudflare Stealth:** Bypasses 5MB proxy limits via mandatory fragment streaming.
...
- [**Technical Programming Guide**](docs/TECHNICAL_GUIDE.md): Architecture, Delta-Sync protocol, Cryptography, and Background Services.
